 ...
 * @author Jean
 */
public class Expiredmem extends javax.swing.JFrame {
   ...
   public void Expiredmem(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM customer WHERE Status = 'EXPIRED CUSTOMER' AND archive='NO' ");
            expired.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
    ...
    private void initComponents() {
        ...
        jScrollPane1.setViewportView(expired);
        ...
        jLabel6.setText("EXPIRED MEMBERS");
    ...
    private void archiveMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_archiveMouseClicked
        ...
        int rowIndex = expired.getSelectedRow();
        if(rowIndex<0){
            JOptionPane.showMessageDialog(null, "Please Select an Account");
        }else{
            TableModel model = expired.getModel();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Expiredmem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Expiredmem().setVisible(true);
            }
        });
    }
