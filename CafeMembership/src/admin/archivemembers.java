 ...
 * @author Jean
 */
public class archivemembers extends javax.swing.JFrame {

    /**
     * Creates new form Expiredmem
     */
    public archivemembers() {
        initComponents();
        Expiredmem();
   ...
   public void Expiredmem(){
        try{
            ...
            ResultSet rs = dbc.getData("SELECT * FROM customer WHERE archive = 'YES' ");
            arch.setModel(DbUtils.resultSetToTableModel(rs));
            rs.close();
    ...
    private void initComponents() {
        ...
        arch.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        restore.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel1.add(restore);
        restore.setBounds(40, 170, 60, 30);
    ...
    private void restoreMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_restoreMouseClicked
          ...
          int rowIndex = arch.getSelectedRow();
        if(rowIndex<0){
            JOptionPane.showMessageDialog(null, "Please Select an Account");
        }else{
            TableModel model = arch.getModel();
            ...
            if(a == JOptionPane.YES_OPTION){
                dbConnector dbc = new dbConnector();
                dbc.insertData("UPDATE customer SET archive='NO' Where ID='"+id+"' ");
                Expiredmem();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(archivemembers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new archivemembers().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTable arch;
