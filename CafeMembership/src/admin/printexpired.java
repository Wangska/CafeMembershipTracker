 ...
 * @author Sofia
 */
public class printexpired extends javax.swing.JFrame {
    ...
    private void add2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_add2MouseClicked
        ...
        MessageFormat header = new MessageFormat("CAFE MEMBERSHIP TRACKER");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(printexpired.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new printexpired().setVisible(true);
            }
        });
    }
